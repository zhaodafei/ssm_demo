...
public class RedisStringUtil extends RedisBaseUtil {
    ...
    public static void main(String[] args) {
        ...
        //RedisStringUtil.delete(CachePrefix.USER_MANAGEMENT,"hello");
        //System.out.println(RedisStringUtil.get(CachePrefix.USER_MANAGEMENT,"hello"));

        RedisStringUtil.setex(CachePrefix.USER_MANAGEMENT,"hello1", "word1", 1);
        RedisStringUtil.setExpire(CachePrefix.USER_MANAGEMENT,"hello1", 20);
        System.out.println(RedisStringUtil.get(CachePrefix.USER_MANAGEMENT,"hello1"));
    }
