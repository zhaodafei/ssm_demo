...
public class MemcachedUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MemcachedUtil.setCache(CachePrefix.USER_MANAGEMENT,"hello", "world"));
        System.out.println(MemcachedUtil.getCache(CachePrefix.USER_MANAGEMENT,"hello"));
